...
# Load input file
file = 'get_food_nutrition'
filename = 'data/single/' +file + '.xlsx'
...
for index, row in dfd.iterrows():
    ...
    if speaker == 'user' and pd.notna(text):
        ...
        # Add conversation_ id to result_NLU_json
...
excel_output_path = 'results-'+ file + '.xlsx'
df_results.to_excel(excel_output_path, index=False)

# # Ensure the expected columns are present
# if 'expected_dst_status' not in df_results.columns:
#     print("expected_dst_status column is missing in df_results")
# if 'expected_dst_intent' not in df_results.columns:
#     print("expected_dst_intent column is missing in df_results")
#
# # Calculate evaluation metrics
# dst_status_accuracy = calculate_accuracy(df_results, 'DST_status')
# dst_intent_accuracy = calculate_accuracy(df_results, 'DST_intent')
#
# print(f'DST Status Accuracy: {dst_status_accuracy}')
# print(f'DST Intent Accuracy: {dst_intent_accuracy}')
#
# # Save to Excel file
# output_excel_file = 'conversation_results.xlsx'
# with pd.ExcelWriter(output_excel_file) as writer:
#     df_results.to_excel(writer, sheet_name='Results', index=False)
#     metrics_df = pd.DataFrame({
#         'Metric': ['DST Status Accuracy', 'DST Intent Accuracy'],
#         'Value': [dst_status_accuracy, dst_intent_accuracy]
#     })
#     metrics_df.to_excel(writer, sheet_name='Metrics', index=False)
#
# print(f'Results and metrics saved to {output_excel_file}')
