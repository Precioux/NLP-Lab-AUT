...
file_path = 'format_C_convert.txt'

# Initialize an empty dictionary for intents
intents = {}
# Read the file and populate the dictionary
with open(file_path, 'r', encoding='utf-8') as file:
    # Execute the content to retrieve the dictionary defined in the file
    exec(file.read())

# Assign the read dictionary to the 'intents' dictionary
intents = description_intent_dict
    ...
    while True:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                intent_label = intents[dst_intent]
                conversation_data.append(' BOT_START '+ intent_label +' BOT_END ')
